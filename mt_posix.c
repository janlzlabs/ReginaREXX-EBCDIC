...
tsd_t *ReginaInitializeThread(void)
{
   ...
   {
#if defined(OS_CALLBACKS) && defined(unix) || defined(__unix__) || defined(__unix) || defined(__QNX__) || defined(__BEOS__) || defined(__HAIKU__) || defined(SKYOS) || ( defined( __APPLE_CC__ ) && defined( __MACH__ ) ) || defined(AIX) || defined(__MINIX__)
      extern OS_Dep_funcs __regina_OS_Callbacks;
      retval->OS = &__regina_OS_Callbacks;
#elif !defined(OS_CALLBACKS) && defined(unix) || defined(__unix__) || defined(__unix) || defined(__QNX__) || defined(__BEOS__) || defined(__HAIKU__) || defined(SKYOS) || ( defined( __APPLE_CC__ ) && defined( __MACH__ ) ) || defined(AIX) || defined(__MINIX__)
...
struct tm *localtime_rexx(const time_t *time)
{
   mt_tsd_t *mt = (mt_tsd_t *)__regina_get_tsd()->mt_tsd;
